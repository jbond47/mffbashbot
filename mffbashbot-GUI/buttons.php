...
print "<option value=\"0\" id=\"freegardenspeedupusefarm0\">Sleep</option>\n";
print "<option value=\"1\" id=\"freegardenspeedupusefarm1\">" . $strings['farm1'] . "</option>\n";
print "<option value=\"2\" id=\"freegardenspeedupusefarm2\">" . $strings['farm2'] . "</option>\n";
print "<option value=\"3\" id=\"freegardenspeedupusefarm3\">" . $strings['farm3'] . "</option>\n";
print "<option value=\"4\" id=\"freegardenspeedupusefarm4\">" . $strings['farm4'] . "</option>\n";
print "<option value=\"5\" id=\"freegardenspeedupusefarm5\">" . $strings['farm5'] . "</option>\n";
print "<option value=\"6\" id=\"freegardenspeedupusefarm6\">" . $strings['farm6'] . "</option></select>&nbsp;" . $strings['freegardenspeedupfarmtext'];
print "</td></tr>";
print "<tr><td>";
print "<select id=\"startvetroledifficulty\" name=\"startvetroledifficulty\" onchange=\"saveMisc();\">";
print "<option value=\"0\" id=\"difficulty0\">Sleep</option>\n";
print "<option value=\"1\" id=\"difficulty1\">" . $strings['easy'] . "</option>\n";
print "<option value=\"2\" id=\"difficulty2\">" . $strings['average'] . "</option>\n";
print "<option value=\"3\" id=\"difficulty3\">" . $strings['hard'] . "</option></select>&nbsp;" . $strings['startvetroletext'];
print "</td></tr>";
...
$savedValue = "freegardenspeedupusefarm" . $savedValue;
print "document.getElementById('freegardenspeedupfarm').selectedIndex = document.getElementById('" . $savedValue . "').index;\n";
$savedValue = $configContents['startvetroledifficulty'];
$savedValue = "difficulty" . $savedValue;
print "document.getElementById('startvetroledifficulty').selectedIndex = document.getElementById('" . $savedValue . "').index;\n";
